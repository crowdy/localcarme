...
try {
  ...
  var notice = childProcess.execSync('pushd . && cd ..\\..\\jupyterlab-org && git describe && popd', { encoding: 'utf8' });
...
for (var i = 0; i < files.length; i++) {
  ...
  // console.log('@jupyterlab/' + package + ': ' + target);

/**
@jupyterlab/about-extension: C:\projectenv\carme\jupyterlab\jupyterlab\build\packages\about-extension\src
*/
}

alias['@types/chart.js'] = path.resolve( path.join(__dirname, '../node_modules/chart.js/dist/Chart.bundle.js') );
