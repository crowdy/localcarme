...
import * as testExtension
  from '@jupyterlab/test-extension';
...
import * as carmeSettingsExtension
  from '@carme/carme-settings';

import * as carmeBookmarkExtension
  from '@carme/carme-bookmark';

import * as carmeProfileExtension
  from '@carme/carme-profile';
...
const mods: JupyterLab.IPluginModule[] = [
  ...
  apputilsExtension,
  carmeSettingsExtension,
  carmeBookmarkExtension,
  carmeProfileExtension,
  codemirrorExtension,
  completerExtension,
  consoleExtension,
  csvwidgetExtension,
