...
class LabHandler(IPythonHandler):
    ...
    def get(self):
        ...
        # background_color = context.get_section_config_value("background_color", category="carme")
        # base_api_url = context.get_section_config_value("base_api_url", category="carme")
        # print("found background color: {}".format(background_color))
        # configData['carme_background_color'] = background_color

        # # be careful the value contains single quotes.
        config['carme_config'] = {
            "user_name": "'admin'",
            "user_role": "'admin'",
            "bg_color": "'#FFF59D'",
            "base_api_url": "'http://dev-manage-api21001.g1.tyo2.v4.internal-gmo:8000'",
            "login_url": "'http://dev-manage-front21001.g1.tyo2.v4.internal-gmo:8080/login'",
        ...
        if "?" in uri:
            ...
            result, msg = bl.is_valid_token(token)
            if result:
