 ...
 */
const LOGO_CLASS = 'jp-Test-logo';

/**
 * The class name added to the main area icon.
 */
const MAIN_AREA_ICON_CLASS = 'jp-Test-hero-mainarea';

/**
 * The class name added the command palette icon.
 */
const COMMAND_ICON_CLASS = 'jp-Test-hero-command';

/**
 * The class name added to the filebrowser icon.
 */
const FILEBROWSER_ICON_CLASS = 'jp-Test-hero-filebrowser';

/**
 * The class name added for the notebook icon.
 */
const NOTEBOOK_ICON_CLASS = 'jp-Test-hero-notebook';

/**
 * The class name added to the main area image.
 */
const MAIN_AREA_IMAGE_CLASS = 'jp-Test-mainarea';

/**
 * The class name added to the command palette image.
 */
const COMMAND_IMAGE_CLASS = 'jp-Test-command';

/**
 * The class name added to the filebrowser image.
 */
const FILEBROWSER_IMAGE_CLASS = 'jp-Test-fb';

/**
 * The class name added to the notebook image.
 */
const NOTEBOOK_IMAGE_CLASS = 'jp-Test-nb';
...
class TestModel extends VDomModel {
   ...
   */
  constructor(options: TestModel.IOptions) {
    super();
